...
Q_DECL_CONSTEXPR int64_t MESSAGE_AMOUNT = 494;
Q_DECL_CONSTEXPR int64_t MESSAGE_CHAR_PRICE = 6;
Q_DECL_CONSTEXPR int64_t MINIMAL_MESSAGE_FEE = MESSAGE_CHAR_PRICE;
Q_DECL_CONSTEXPR int DEFAULT_MESSAGE_MIXIN = 1;
