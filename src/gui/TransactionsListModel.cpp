...
bool TransactionsListModel::filterAcceptsColumn(int _sourceColumn, const QModelIndex& _sourceParent) const {
  ...
  return column == TransactionsModel::COLUMN_STATE || column == TransactionsModel::COLUMN_DATE || column == TransactionsModel::COLUMN_HEIGHT ||
    column == TransactionsModel::COLUMN_AMOUNT || column == TransactionsModel::COLUMN_ADDRESS || column == TransactionsModel::COLUMN_FEE ||
    column == TransactionsModel::COLUMN_MESSAGE || column == TransactionsModel::COLUMN_HASH || column == TransactionsModel::COLUMN_PAYMENT_ID;
}
