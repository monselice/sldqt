...
TransactionsFrame::TransactionsFrame(QWidget* _parent) : QFrame(_parent), m_ui(new Ui::TransactionsFrame),
  ...
  m_ui->m_transactionsView->header()->resizeSection(TransactionsModel::COLUMN_HEIGHT, 70);
  m_ui->m_transactionsView->header()->resizeSection(TransactionsModel::COLUMN_AMOUNT, 90);
  m_ui->m_transactionsView->header()->resizeSection(TransactionsModel::COLUMN_DATE, 100);
  m_ui->m_transactionsView->header()->resizeSection(TransactionsModel::COLUMN_FEE, 70);
  m_ui->m_transactionsView->header()->resizeSection(TransactionsModel::COLUMN_HASH, 450);
